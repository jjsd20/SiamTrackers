...
def main():
    ...
    parser.add_argument('--vis', default=True, help='whether visualzie result')
    args = parser.parse_args()

    torch.set_num_threads(5)

    # load config
    dataset_root = '/home/xyz/data/' + args.dataset
    #  tracker
                ...
                if args.vis and idx > frame_counter:
                    ...
                    if False:
                        ...
                        cv2.rectangle(img, (bbox[0], bbox[1]),
                                      (bbox[0] + bbox[2], bbox[1] + bbox[3]), (0, 255, 255), 3)#黄色
                    cv2.putText(img, str(idx), (40, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)#黄色
                    cv2.putText(img, str(lost_number), (40, 80), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)#红色
